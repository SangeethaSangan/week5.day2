...
public class DuplicateLead extends BaseClass{
	...
	public void setFileName() {
		excelFileName ="DuplicateLead";// set excel file name
	}
     @Test(dataProvider="fetchData",enabled=false)
	 void duplicateLead(String companyname,String firstname,String lastname,String fNameLocal,String lNameLocal,String Dept,String Description,String email,String SourceId,String Country,String NewCompanyName,String NewFirstName) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).clear();//clear already present company name
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys(NewCompanyName);//update new company name
		driver.findElement(By.id("createLeadForm_firstName")).clear();//clear already present first name
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys(NewFirstName);//update new first name
		driver.findElement(By.name("submitButton")).click();//click submit button

		String Title1 = driver.getTitle();//get current title of the page
