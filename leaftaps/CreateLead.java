...
public class  CreateLead extends BaseClass {
	...
	public void setFileName() {
		excelFileName = "CreateLead";// set excel file name
	}
		@Test(priority=1,dataProvider="fetchData")//,
		
		void createLead(String companyname,String firstname,String lastname,String fNameLocal,String lNameLocal,String Dept,String Description,String email,String SourceId,String Country) {
